...
public class inserting extends JComponent{
    ...
    public inserting() {
        inserting.this.setPreferredSize(dimension);
        inserting.this.setOpaque(false);
        inserting.this.setSizeMode(SizeMode.STRETCH);
    }
